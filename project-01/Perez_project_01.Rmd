...
The objetive is to make use of the toolset and principles of data visualization, displaying and uncovering trends, patterns, tendencies, and outlieres, using ggplot for R, this report will create:
...
```{r get_working_directory, echo=FALSE, warning=FALSE,  message=FALSE,}
getwd()
```
...
#### Using head() to visualizate the data set.


```{r read_data_Set, echo=FALSE, warning=FALSE,  message=FALSE,}
...
#### Using srt() to visualizate the structure of the data set.


```{r view_data_set_structure, echo=FALSE, warning=FALSE,  message=FALSE,}
str(all_summer)
```
...
#### Visualization of Grouped Data by Decade
...
#### Creating Data Means of Numeric Variables.
...
```
#### Transposing Data Set for Multiple Line Visualization
...
#### Creating Data Frame of Non-numeric Variables.
...
#### Visualization of Non-numeric Variables.
...
```{r carsktable, results="asis", echo=FALSE, warning=FALSE,  message=FALSE,}
